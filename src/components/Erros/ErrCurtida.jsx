...
const ErrCurtida = ({ error, setErrorCurtida}) => {
    function closeModal() {
        document.getElementById("my-modalcurtida").classList.add("hidden");
        setErrorCurtida(false);
      ...
      return (
        <>
          <div class="fixed z-10 inset-0 overflow-y-auto" id="my-modalcurtida">
